...
namespace KursProjectTimetable {
	...
	/// <summary>
	/// Summary for AddFacultyForm
	/// </summary>
	public ref class AddFacultyForm : public System::Windows::Forms::Form
	{
	public:
		AddFacultyForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AddFacultyForm::typeid));
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &AddFacultyForm::textBox1_TextChanged);
			// 
			// label1
			// 
