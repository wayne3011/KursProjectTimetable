...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Введите номер курса:";
			// 
			// textBox2
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &AddCourseForm::textBox2_TextChanged);
			// 
			// addButton
			// 
			...
			this->addButton->MouseEnter += gcnew System::EventHandler(this, &AddCourseForm::addButton_MouseEnter);
			this->addButton->MouseLeave += gcnew System::EventHandler(this, &AddCourseForm::addButton_MouseLeave);
			// 
			// AddCourseForm
			// 
