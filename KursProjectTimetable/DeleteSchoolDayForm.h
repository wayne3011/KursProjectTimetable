...
namespace KursProjectTimetable {
	...
	/// </summary>
	public ref class DeleteSchoolDayForm : public System::Windows::Forms::Form
	{
	public:
		DeleteSchoolDayForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DeleteSchoolDayForm::typeid));
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &DeleteSchoolDayForm::textBox1_TextChanged);
			// 
			// label1
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &DeleteSchoolDayForm::textBox2_TextChanged);
			// 
			// textBox3
			// 
			...
			this->textBox3->TextChanged += gcnew System::EventHandler(this, &DeleteSchoolDayForm::textBox3_TextChanged);
			// 
			// addButton
			// 
			...
			this->addButton->Click += gcnew System::EventHandler(this, &DeleteSchoolDayForm::addButton_Click);
			this->addButton->MouseEnter += gcnew System::EventHandler(this, &DeleteSchoolDayForm::addButton_MouseEnter);
			this->addButton->MouseLeave += gcnew System::EventHandler(this, &DeleteSchoolDayForm::addButton_MouseLeave);
			// 
			// label4
			// 
			...
			this->textBox4->TextChanged += gcnew System::EventHandler(this, &DeleteSchoolDayForm::textBox4_TextChanged);
			// 
			// DeleteSchoolDayForm
			// 
			...
			this->Name = L"DeleteSchoolDayForm";
			this->Text = L"DeleteSchoolDayForm";
